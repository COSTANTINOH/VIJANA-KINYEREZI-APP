...
/// See also:
///
///  * [JTDropDownMenu], which integrates with the [Form] widget.
...
///    integration.
class JTDropDownMenu<T> extends FormField<T> {
...
class _DropdownButtonFormFieldState<T> extends FormFieldState<T> {
  @override
  JTDropDownMenu<T> get widget =>
      super.widget as JTDropDownMenu<T>;
  ...
  @override
  void didUpdateWidget(JTDropDownMenu<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
